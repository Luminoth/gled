...
#include "src/core/math/Matrix3.h"
...
#include "src/engine/renderer/Mesh.h"
...
private:
    struct Surface
    {
        ...
        GLuint textures[Renderable::TextureBuffers::TextureBufferCount];

        GLuint vbo[Renderable::RenderBuffers::GeometryVBOCount];
...
public:
    static void destroy(D3Map* const map, MemoryAllocator* const allocator);

private:
    static void destroy_entity(Entity* const entity, MemoryAllocator* const allocator);
    static void destroy_brush(Brush* const brush, MemoryAllocator* const allocator);
    static void destroy_patch2(Patch2* const patch, MemoryAllocator* const allocator);
    static void destroy_patch3(Patch3* const patch, MemoryAllocator* const allocator);
    static void destroy_model(Model* const model, MemoryAllocator* const allocator);
    static void destroy_surface(Surface* const surface, MemoryAllocator* const allocator);
