...
public:
    ...
    bool keyboard_key(InputKeySym key) const { return _keyboard_state[key]; }
    ...
    bool mouse_button(MouseSym button) const { return _mouse_state.buttons[button]; }

private:
    bool _keyboard_state[InputKeySym_max];
