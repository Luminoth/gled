...
{
public:
    static void destroy(MD5Mesh* const mesh, MemoryAllocator* const allocator);

public:
    MD5Mesh(const std::string& material, size_t vcount, boost::shared_array<Vertex> vertices, size_t tcount, boost::shared_array<Triangle> triangles, size_t wcount, boost::shared_array<Weight> weights);
...
public:
    ...
    static void destroy(MD5Model* const model, MemoryAllocator* const allocator);
