...
public:
    ...
    static void destroy(Animation* const animation, MemoryAllocator* const allocator);
...
protected:
    ...
    void add_base_joint(boost::shared_ptr<Skeleton::Joint> joint) { _skeleton.add_joint(joint); }
