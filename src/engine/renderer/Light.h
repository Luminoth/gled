...
{
public:
    static void destroy(PositionalLight* const light, MemoryAllocator* const allocator);
...
{
public:
    static void destroy(DirectionalLight* const light, MemoryAllocator* const allocator);
...
{
public:
    static void destroy(SpotLight* const light, MemoryAllocator* const allocator);
