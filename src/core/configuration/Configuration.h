...
public:
    ...
    void set_help(const std::string& section, const std::string& option, const std::string& help);
    ...
    void set_read_only(const std::string& section, const std::string& option, bool readonly=true);
